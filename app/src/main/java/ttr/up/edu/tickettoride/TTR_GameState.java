...
public class TTR_GameState extends GameState{
    ...
    private TrainPieceStash trainPieceStash; //todo refactor to be a route manager
    ...
    public TTR_GameState(TTR_GameState state) throws CloneNotSupportedException {
        ...
        this.blueTrains = state.blueTrains;
        this.redTrains = state.redTrains;
        this.greenTrains = state.greenTrains;
        this.yellowTrains = state.yellowTrains;
        this.blackTrains = state.blackTrains;
    }
